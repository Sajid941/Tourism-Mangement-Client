        ...
        <div className="navbar bg-base-100 shadow-lg px-10 fixed z-10">
            ...
            <div className="navbar-end space-x-3">
                <label className="cursor-pointer grid place-items-center">
                    <input onChange={()=> setDarkMode(!darkMode)} type="checkbox" value="synthwave" className="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2" />
